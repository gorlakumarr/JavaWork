...
public class CreateLeadPage extends LeafTapsWrappers{
	...
	public CreateLeadPage enterownershipEnumId(String ownershipEnumId) throws InterruptedException{
		selectVisibileTextById(prop.getProperty("CreateLead.createLeadForm_ownershipEnumId.selectVisibileTextById"), ownershipEnumId);
		Thread.sleep(2000);
		return this;
	}
	...
	public CreateLeadPage entergeneralStateProvinceGeoId(String generalStateProvinceGeoId) throws InterruptedException{
		selectVisibileTextById(prop.getProperty("CreateLead.generalStateProvinceGeoId.selectVisibileTextById"), generalStateProvinceGeoId);
		Thread.sleep(2000);
		return this;
		}
